        ...
        <div className="min-h-screen bg-white">
                ...
                <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <p className="mt-4 text-xl text-indigo-100">
                            체계적이고 전문적인 협업 프로세스로 성공적인 게임 홍보를 지원합니다.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold text-gray-900">5단계 협업 프로세스</h2>
                    <p className="mt-4 text-lg text-gray-600">
                        간단한 등록부터 성과 분석까지, 모든 과정을 체계적으로 관리합니다.
                    </p>
                </div>
                    ...
                    {collaborationSteps.map((step, index) => (
                        <div key={step.step} className="relative">
                            ...
                            {index < collaborationSteps.length - 1 && (
                                <div className="absolute left-8 top-16 h-24 w-0.5 bg-indigo-200 lg:left-1/2 lg:ml-0"></div>
                            )}
            ...
            <div className="bg-gray-50 py-16">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900">협업 혜택</h2>
                        <p className="mt-4 text-lg text-gray-600">
                            HGE Creator와의 협업으로 얻을 수 있는 다양한 혜택들입니다.
                        </p>
                    </div>
            ...
            <div className="bg-indigo-600 py-16">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="mt-4 text-xl text-indigo-100">
                        전문적인 협업 프로세스로 여러분의 게임을 성공으로 이끌어드리겠습니다.
                    </p>
                    <div className="mt-8">
                        <a
                            href="/participate"
